...
<Steps>
  ...
  <Step title="Take Photos">
    Position your item(s) in good lighting and take clear photos. Free users can add 1 photo per item, while MovingBox Pro users can add up to 5 photos for enhanced documentation.
    ...
    <Note>
      **Multi-Item Detection**: You can now photograph multiple items at once! Our AI will automatically detect and catalog each item separately - perfect for shelves, cabinets, or any space with multiple items. This dramatically reduces the time needed to catalog your belongings.
    </Note>
  </Step>

  <Step title="Review Enhanced AI Results">
    The app will process your photos with high-resolution AI analysis (up to 1250x1250px for Pro users) and display detailed item information. If multiple items were detected, you'll see each one listed separately.
  </Step>

  <Step title="Edit if Necessary">
    Review the information for each detected item and make any needed adjustments:
    - Correct item names if needed
    - Adjust labels and locations if misidentified
    - Add or edit any details
    - Remove any items that were incorrectly detected
  </Step>

  <Step title="Save the Items">
    Tap "Save" to add all items to your inventory at once
  </Step>
</Steps>
