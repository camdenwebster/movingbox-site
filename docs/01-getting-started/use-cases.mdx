...
<div className="grid grid-cols-3 gap-4">
  <div className="col-span-2">
    ...
    <ul>
      <li>Create a complete inventory of your belongings before packing using multi-item detection to catalog entire shelves and cabinets quickly</li>
    ...
    <p>With MovingBox's multi-item detection, you can photograph entire rooms section by section, dramatically reducing the time needed to catalog your belongings before a move.</p>
  </div>
...
<Tip>
  Use multi-item detection to catalog entire shelves of collectibles at once. Perfect for book collections, vinyl records, or display cases with multiple items.
</Tip>
